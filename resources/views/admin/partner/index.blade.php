        ...
        $('#datatable').DataTable( {
            ...
            columns: [
                ...
                },
                {
                    data: 'link',
                    render: function (data, type, row, meta) {
                        return '<a target="_blank" href="'+data+'">' + data + '</span>';
                    }
                },
                {
                    data: 'image',
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        var btn_detail = `
                            <a href="{{ url("/admin/partner/`+data+`") }}" class="btn btn-sm btn-icon btn-info flex-end" data-bs-toggle="tooltip" aria-label="Detail" data-bs-original-title="Detail">
                        ...
                        var btn_edit = `
                            <a href="{{ url("/admin/partner/`+data+`/edit") }}" class="btn btn-sm btn-icon btn-warning flex-end" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
                                <span class="btn-inner">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
